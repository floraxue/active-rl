...
def main():
    fpath = '/data/active-rl-data/ground_truth/cat_gt.txt'
    dic = {}
    ...
    pickle.dump(dic,
                open('/data/active-rl-data/ground_truth/cat_gt_cached.p', 'wb'))

    train_dir = join(data_root, 'images', 'train', 'cat')
    ...
    out_remove_keys = '/data/active-rl-data/ground_truth/no_gt_removed_keys.txt'
